...
Route::get('/main-by-date-v140/{date}', [ApiController::class, 'getMainByDateV1_5_0']); //added W3/W7 results
...
Route::get('/tmain-by-date-v3/{date}', [ApiController::class, 'getTMainByDateV1_4_0']); //results from db
...
Route::get('/data-by-history-v140', [ApiController::class, 'getDataByAdvanceSearchv140']);
