...
Route::get('/slive/{date}', [ApiController::class, 'getMainByDateV1_3_0s']); ///main-by-date-v130/{date}
Route::get('/tlive/{date}', [ApiController::class, 'getMainByDateV1_3_0']); ///main-by-date-v130/{date}
...
Route::get('/tsearchnumber', [ApiController::class, 'getDataByAdvanceSearchv130']);//data-by-history-v130
Route::get('/ssearchnumber', [ApiController::class, 'getDataByAdvanceSearchv130s']);//data-by-history-v130

Route::get('/numbermeaning', [ApiController::class, 'getDicByData']);//data-by-dictionary
// Route::get('/save-by-date/{date}', [ApiController::class, 'saveData']);
// Route::get('/save-by-live', [ApiController::class, 'saveLive']);
Route::get('/timeline', [ApiController::class, 'drawDrawList']);//date-by-list

Route::get('/pastdraw', [ApiController::class, 'getDrawdateData']);//data-draw-date
