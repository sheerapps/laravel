...
class ApiController extends Controller
{
    ...
    public function getMainByDate($date){
        ...
        $url_sub = "https://good4d.net/getLiveResult.php";
        ...
        if($date == "date" || $date >= $today){
            ...
            $url_sub = "https://good4d.net/getLiveResult.php?date=".$date;
            $url_nl = "past";
        }
        //is Live
        ...
        curl_setopt($ch2, CURLOPT_HTTPHEADER, ['referer: https://good4d.net/en/past-result']);
        curl_setopt($ch2, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch2, CURLOPT_TIMEOUT, 2);
        curl_setopt($ch2, CURLOPT_CONNECTTIMEOUT, 2);
        $res2 = curl_exec($ch2);
