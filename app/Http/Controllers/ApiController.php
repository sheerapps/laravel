    ...
    public function sub_formatter($array,$date){
        return [
            ...
            "LH"=>[
                ...
                "jp1" => !isset($array->R->_1[0]) ? "------" : $array->R->_1[0],
                "jp2" => !isset($array->R->_2[0]) ? "-----" : $array->R->_2[0],
                "jp3" => !isset($array->R->_2[1]) ? "-----" : $array->R->_2[1],
                "jp4" => !isset($array->R->_3[0]) ? "----" : $array->R->_3[0],
                "jp5" => !isset($array->R->_3[1]) ? "----" : $array->R->_3[1],
                "jp7" => !isset($array->R->_4[0]) ? "---" : $array->R->_4[0],
                "jp8" => !isset($array->R->_4[1]) ? "---" : $array->R->_4[1],
                "jp9" => !isset($array->R->_5[0]) ? "--" : $array->R->_5[0],
                "jp10" => !isset($array->R->_5[1]) ? "--" : $array->R->_5[1],
